...
namespace EzirizTest.Properties
{
    public class CilMethodBodyTest
    {
        private static CilMethodBody ReadMethodBody(string name)
        {
        ...
        private static CilMethodBody RebuildAndLookup(MethodBody methodBody)
        {
